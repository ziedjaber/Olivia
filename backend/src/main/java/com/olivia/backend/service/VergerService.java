...
public class VergerService {
        ...
        try {
            ...
            for (QueryDocumentSnapshot document : query.getDocuments()) {
                try {
                    ...
                    log.error("Erreur de lecture sur un document verger (ID: {}). Données corrompues ignorées. Erreur: {}", 
    ...
    public Verger createVerger(Verger verger) {
        try {
            ...
            data.put("datePlantation", verger.getDatePlantation() != null ? verger.getDatePlantation().toString() : null);
            data.put("dateReferenceCalculGDD", verger.getDateReferenceCalculGDD() != null ? verger.getDateReferenceCalculGDD().toString() : null);
            ...
            data.put("dateMaturitePrevue", verger.getDateMaturitePrevue() != null ? verger.getDateMaturitePrevue().toString() : null);
    ...
    public Verger updateVerger(String id, Verger vergerDetails) {
        ...
        try {
            ...
            data.put("datePlantation", vergerDetails.getDatePlantation() != null ? vergerDetails.getDatePlantation().toString() : null);
            data.put("dateReferenceCalculGDD", vergerDetails.getDateReferenceCalculGDD() != null ? vergerDetails.getDateReferenceCalculGDD().toString() : null);
            ...
            data.put("dateMaturitePrevue", vergerDetails.getDateMaturitePrevue() != null ? vergerDetails.getDateMaturitePrevue().toString() : null);
