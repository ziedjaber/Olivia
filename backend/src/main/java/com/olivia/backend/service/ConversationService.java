...
public class ConversationService {
    ...
    public Conversation getOrCreate(String userId1, String userId2) {
        try {
            ...
            return existing.stream()
                ...
                .findFirst()
                .orElseGet(() -> createConversation(db, userId1, userId2));
    ...
    private Conversation createConversation(Firestore db, String id1, String id2) {
        try {
   ...
   public List<Conversation> getConversationsByUser(String userId) {
    try {
        ...
        List<Conversation> convs = firestore.collection("conversations")
