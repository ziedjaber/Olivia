...
//*********Modifié pour l'affichage du nom de l'utilisateur******
// package com.olivia.backend.model;
...
//     // Initialisation par défaut + getter personnalisé pour éviter null
//     private Map<String, String> participantNames = new HashMap<>();
//     private Map<String, String> participantRoles = new HashMap<>();
//     private Map<String, Integer> unreadCount = new HashMap<>();
...
//     // Getters sécurisés (très important)
...
//     // Setters (optionnel mais recommandé pour la cohérence)
