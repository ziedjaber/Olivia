...
public class ParticipationController {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_CHEF_EQUIPE_RECOLTE', 'ROLE_DIRECTEUR')")
    public ResponseEntity<?> updateSalary(@PathVariable String id, @RequestParam Double dailySalary) {
        try {
            Participation p = participationService.updateSalary(id, dailySalary);
            return ResponseEntity.ok(p);
        } catch (Exception e) {
