...
export interface Collecte {
  ...
  requiredResources?: { resourceId: string, resourceName: string, quantity: number, justification?: string }[];
}
...
export class CollecteService {
  ...
  getAssignedCollectes(): Observable<Collecte[]> {
    return this.http.get<Collecte[]>(`${this.apiUrl}/assigned`);
  }
