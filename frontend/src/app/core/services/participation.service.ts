...
export class ParticipationService {
  ...
  getParticipationsByCollecte(collecteId: string): Observable<Participation[]> {
    return this.http.get<Participation[]>(`http://localhost:8080/api/collectes/${collecteId}/participations`);
  }
