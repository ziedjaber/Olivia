      ...
      <section class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <tr *ngFor="let p of participations" 
                     ...
                     <td class="px-6 py-6 border-r border-dashed border-stone-100">
                        <div class="space-y-3">
                           <div class="flex items-start gap-2">
                              ...
                              <div>
                                 <span class="block text-[10px] font-black text-on-surface uppercase tracking-wider">{{ p.collecteLocation || 'Lieu en attente' }}</span>
                                 <span class="text-[8px] text-outline font-bold tracking-widest uppercase">Nom du verger</span>
                              </div>
                           </div>
                           <div class="flex items-start gap-2">
                              ...
                              <div>
                                 ...
                                 <span class="text-[8px] text-outline font-bold tracking-widest uppercase">Duree de recolte</span>
                              </div>
                           </div>
                        </div>
                     </td>
                     ...
                     <td class="px-6 py-6 border-r border-dashed border-stone-100">
                        <div class="flex flex-col gap-1">
                           ...
                           <span *ngIf="!p.salaryPaid" class="text-[8px] font-black text-outline uppercase tracking-[0.2em]">Taux journalier propose</span>
                           <span *ngIf="p.salaryPaid" class="text-[8px] font-black text-emerald-600 uppercase tracking-[0.2em] flex items-center gap-1"><span class="material-symbols-outlined text-[10px]">check_circle</span> Paiement recu</span>
                     ...
                     <td class="px-6 py-6 text-right">
                        <div *ngIf="p.status === 'INVITED'" class="flex gap-2 justify-end">
                           <button (click)="reject(p)" class="px-4 py-2 bg-white border border-stone-200 text-stone-900 text-[9px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-stone-50 transition-all active:scale-95 shadow-sm">Refuser</button>
                           <button (click)="accept(p)" class="px-4 py-2 bg-black text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-xl shadow-md hover:bg-stone-800 transition-all active:scale-95">Accepter</button>
                        </div>
        ...
        <div class="space-y-6">
           <div class="bg-primary/5 border border-primary/10 p-8 rounded-[2.5rem] flex flex-col items-center text-center shadow-sm">
              ...
              <h5 class="text-lg font-black text-on-surface mb-2">Talent d'elite</h5>
              <p class="text-[10px] text-outline font-medium tracking-tight leading-relaxed mb-6">Votre precision de recolte est remarquable. Continuez a accepter des missions pour maintenir votre classement A+.</p>
              <button class="w-full py-3 bg-white text-primary font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-primary hover:text-white transition-all shadow-sm border border-primary/20">Voir les details du classement</button>
           </div>
           ...
           <div class="bg-stone-50 border border-stone-100 p-8 rounded-[2.5rem] flex flex-col gap-4 shadow-sm">
              ...
              <p class="text-[10px] text-outline font-medium tracking-tight">Exigence : un equipement de protection certifie doit etre porte en permanence pendant la recolte. Tout non-respect peut entrainer l'exclusion de la mission.</p>
           </div>
        </div>
