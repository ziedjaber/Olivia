  ...
  template: `
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-10 animate-fade-in">
      ...
      <header class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-stone-100 pb-8">
        <div>
          <span class="text-[10px] font-black text-[#3e5219] uppercase tracking-[0.4em] mb-2 block">Finances personnelles</span>
          <h1 class="text-4xl font-black text-[#1e1c12] font-headline tracking-tighter">Mes <span class="text-[#3e5219] italic">gains</span></h1>
          <p class="text-stone-500 font-medium mt-1 opacity-60">Suivez vos paiements de mission et votre historique financier.</p>
        </div>
        ...
        <div class="flex gap-4">
           <div class="bg-white/80 backdrop-blur-md px-6 py-4 rounded-3xl border border-stone-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                <span class="text-[9px] font-black text-stone-400 uppercase tracking-wider block">Total gagne</span>
      ...
      <div *ngIf="loading" class="py-20 flex flex-col items-center justify-center text-stone-300 animate-pulse">
         ...
         <p class="text-[10px] font-black uppercase tracking-widest">Synchronisation du registre...</p>
      </div>
      ...
      <div *ngIf="!loading && earnings.length === 0" class="py-32 text-center border-2 border-dashed border-stone-100 rounded-[3rem] bg-stone-50/30">
         ...
         <h4 class="text-xl font-black text-on-surface mb-2">Aucun gain pour le moment</h4>
         <p class="text-sm text-outline font-medium max-w-xs mx-auto">Terminez votre premiere mission de recolte pour voir vos gains ici.</p>
      </div>
            ...
            <table class="w-full text-left">
               <thead>
                  <tr class="bg-stone-50/50">
                     ...
                     <th class="px-8 py-5 text-[10px] font-black text-stone-400 uppercase tracking-widest text-right">Paiement journalier</th>
                     ...
                     <td class="px-8 py-6 text-center">
                        <div class="flex items-center justify-center gap-2">
                           <span *ngIf="p.salaryPaid" class="flex items-center gap-1.5 px-3 py-1 bg-emerald-500/10 text-emerald-600 rounded-full">
                              ...
                              <span class="text-[9px] font-black uppercase tracking-widest">Paye</span>
                           </span>
                           <span *ngIf="!p.salaryPaid" class="flex items-center gap-1.5 px-3 py-1 bg-amber-500/10 text-amber-600 rounded-full">
                              ...
                              <span class="text-[9px] font-black uppercase tracking-widest">En attente</span>
                           </span>
                        </div>
                     </td>
                  </tr>
