  ...
  template: `
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-10 animate-fade-in font-headline">
      ...
      <header class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-stone-100 pb-8">
        <div>
          <span class="text-[10px] font-black text-[#3e5219] uppercase tracking-[0.4em] mb-2 block">
            Gestion d'infrastructure
          </span>

          <h1 class="text-4xl font-black text-[#1e1c12] tracking-tighter">
            Unités de <span class="text-[#3e5219] italic">Trituration</span>
          </h1>

          <p class="text-[#1e1c12]/60 font-medium mt-1 italic">
            Contrôle et suivi des unités industrielles de trituration.
          </p>
        </div>
        ...
        <div class="flex gap-4">
          <button
            (click)="loadCenters()"
            class="p-3 bg-white/80 backdrop-blur-md rounded-2xl border border-stone-100 hover:bg-white hover:scale-105 transition-all shadow-sm"
          >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-[3rem] p-4 border border-stone-100 shadow-2xl h-[500px] relative group overflow-hidden">
          ...
          <div class="absolute top-8 left-8 z-10 bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl shadow-lg border border-stone-100 pointer-events-none">
            <p class="text-[9px] font-black text-[#3e5219] uppercase tracking-widest leading-none mb-1">
              Géographie des unités
            </p>

            <p class="text-[11px] font-bold text-stone-600">
              Cliquez sur la carte pour localiser une nouvelle unité
            </p>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-[2.5rem] p-8 border border-stone-100 shadow-xl space-y-4">
            ...
            <span class="text-[10px] font-black text-stone-400 uppercase tracking-widest block font-headline">
              Filtrage rapide
            </span>

            <div class="relative">
              <span class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-stone-300">
                search
              </span>
          ...
          <div class="bg-stone-900 rounded-[2.5rem] p-8 shadow-2xl text-white relative overflow-hidden group">
            ...
            <p class="text-[9px] font-black text-white/40 uppercase tracking-widest mb-4">
              Capacité du réseau
            </p>

            <div class="flex items-baseline gap-2 mb-2">
              <span class="text-4xl font-black tracking-tighter">
                {{ totalCapacity | number:'1.0-0' }}
              </span>

              <span class="text-sm font-black text-white/40 uppercase">
                KG/Jour
              </span>
            </div>
          ...
          <table class="w-full text-left border-collapse">
            ...
            <thead>
              <tr class="bg-stone-50/50 border-b border-stone-100">
                ...
                <th class="px-8 py-6 text-[10px] font-black text-stone-400 uppercase tracking-widest">
                  Unité industrielle
                </th>
                ...
                <th class="px-8 py-6 text-[10px] font-black text-stone-400 uppercase tracking-widest text-center">
                  Charge quotidienne
                </th>
                ...
                <th class="px-8 py-6 text-[10px] font-black text-stone-400 uppercase tracking-widest text-right">
                  Actions
                </th>
            ...
            <tbody class="divide-y divide-stone-50">
              ...
              <tr
                *ngFor="let center of filteredCenters"
                class="group hover:bg-[#3e5219]/[0.02] transition-colors"
              >
                ...
                <td class="px-8 py-7">
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      <p class="font-black text-[#1e1c12] text-lg tracking-tight leading-none mb-1">
                        {{ center.name }}
                      </p>

                      <p class="text-[9px] font-black text-stone-400 uppercase tracking-widest">
                ...
                <td class="px-8 py-7">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="material-symbols-outlined text-stone-300 text-lg">
                      location_on
                    </span>

                    <span class="text-xs font-black text-stone-600 uppercase">
                      {{ center.locationName }}
                    </span>
                ...
                <td class="px-8 py-7 text-center">
                  ...
                  <span class="text-sm font-black text-[#1e1c12]">
                    {{ center.dailyCapacityKg | number:'1.0-0' }}
                  </span>

                  <span class="text-[9px] font-black text-stone-400 uppercase ml-1">
                    KG
                  </span>
                ...
                <td class="px-8 py-7 text-right">
                  ...
                  <div class="flex justify-end gap-2">
                    ...
                    <button
                      (click)="onEdit(center)"
                      class="w-10 h-10 rounded-xl bg-white border border-stone-200 text-stone-400 hover:text-[#3e5219] hover:border-[#3e5219]/30 flex items-center justify-center transition-all shadow-sm"
                    >
                      <span class="material-symbols-outlined text-lg">edit</span>
                    </button>

                    <button
                      (click)="onDelete(center.id)"
                      class="w-10 h-10 rounded-xl bg-white border border-stone-200 text-stone-400 hover:text-red-600 hover:border-red-200 flex items-center justify-center transition-all shadow-sm"
                    >
      ...
      <div *ngIf="showForm" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div
          class="absolute inset-0 bg-stone-900/60 backdrop-blur-xl"
          (click)="toggleForm()"
        ></div>
        ...
        <div class="relative bg-[#f4edde] w-full max-w-2xl rounded-[3rem] shadow-2xl p-10 space-y-8 border border-white/20 animate-slide-up">
          ...
          <header>
            ...
            <span class="text-[10px] font-black text-[#3e5219] uppercase tracking-[0.3em] block mb-2">
              Enregistrement de l'unité
            </span>

            <h3 class="text-3xl font-black text-[#1e1c12] tracking-tighter">
              {{ isEditing ? 'Mettre à jour' : 'Initialiser' }}
              l'unité de trituration
            </h3>
          ...
          <form class="space-y-6" (ngSubmit)="saveCenter()">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <label class="block md:col-span-2">
                ...
                <span class="text-[10px] font-black text-[#1e1c12]/40 uppercase tracking-widest ml-4 block mb-2">
                  Nom officiel de l'unité
                </span>

                <input
                  type="text"
                  [(ngModel)]="currentCenter.name"
                  name="name"
                  placeholder="Huilerie Centrale de Sfax"
              ...
              <label class="block">
                ...
                <input
                  type="text"
                  [(ngModel)]="currentCenter.locationName"
                  name="location"
              ...
              <label class="block">
                ...
                <input
                  type="text"
                  [(ngModel)]="currentCenter.contactNumber"
                  name="contact"
                  placeholder="+216 ..."
                  class="w-full bg-white border border-stone-100 rounded-2xl px-6 py-4 text-sm font-black outline-none focus:border-[#3e5219] shadow-sm"
                >
              ...
              <label class="block">
                ...
                <span class="text-[10px] font-black text-[#1e1c12]/40 uppercase tracking-widest ml-4 block mb-2">
                  Capacité quotidienne (KG)
                </span>

                <input
                  type="number"
                  [(ngModel)]="currentCenter.dailyCapacityKg"
                  name="capacity"
                  class="w-full bg-white border border-stone-100 rounded-2xl px-6 py-4 text-sm font-black outline-none focus:border-[#3e5219] shadow-sm"
                >
              </label>
              ...
              <div class="md:col-span-2 p-6 bg-stone-100/50 rounded-3xl border border-stone-100 flex items-center justify-between">
                ...
                <div>
                  ...
                  <p class="text-[10px] font-black text-[#1e1c12]/40 uppercase tracking-widest leading-none mb-1">
                    Coordonnées géographiques
                  </p>

                  <p class="text-xs font-black text-[#1e1c12]">
                ...
                <span class="material-symbols-outlined text-[#3e5219] opacity-20 text-4xl">
                  map
                </span>
            ...
            <div class="flex gap-4 pt-4">
              ...
              <button
                type="button"
                (click)="toggleForm()"
                class="flex-1 py-4 bg-white border border-stone-200 text-[#1e1c12] text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-stone-50 transition-all font-headline"
              >
                Annuler
              </button>
              ...
              <button
                type="submit"
                [disabled]="!currentCenter.name || !currentCenter.latitude"
...
export class MillingCenterManagementComponent implements OnInit, AfterViewInit {
  ...
  get totalCapacity() {
    return this.centers.reduce(
      (acc, c) => acc + (c.dailyCapacityKg || 0),
      0
    );
  }
  ...
  private initMap() {
    ...
    this.map.on('click', (e: any) => {
      ...
      this.ngZone.run(() => {
          ...
          html: `
            ...
            ">
              <span class="material-symbols-outlined"
                style="transform:rotate(45deg); font-size:16px;">
                factory
              </span>
            </div>
          `,
        ...
        this.clickMarker = this.L.marker(
          e.latlng,
          { icon: pinIcon }
        ).addTo(this.map);
  ...
  saveCenter() {
    ...
    const request =
      this.isEditing && this.currentCenter.id
        ? this.centerService.updateCenter(
            this.currentCenter.id,
            this.currentCenter as MillingCenter
          )
    ...
    request.subscribe({
      ...
      next: () => {
        ...
        this.dialogService.alert(
          "Succès",
          "Unité de trituration mise à jour avec succès.",
          "success"
        );
      },
      ...
      error: () => {
        ...
        this.dialogService.alert(
          "Erreur",
          "Échec de synchronisation des données de l'unité.",
          "danger"
        );
      }
    });
  ...
  async onDelete(id: string | undefined) {
    ...
    const ok = await this.dialogService.confirm(
      "Supprimer l'unité",
      "Supprimer définitivement cette unité industrielle ?",
      "danger"
    );
