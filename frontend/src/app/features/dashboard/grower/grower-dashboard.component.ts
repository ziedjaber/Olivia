  ...
  template: `
    <div class="max-w-7xl mx-auto py-6">
      <header class="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h1 class="text-4xl font-extrabold text-on-surface font-headline tracking-tight mb-2">Portail Oléiculteur</h1>
          <p class="text-on-surface-variant">Surveillance de vos vergers et suivi des rendements.</p>
        </div>
        <div class="bg-tertiary-container/30 px-4 py-2 rounded-xl flex items-center gap-3 border border-tertiary/20">
          ...
          <span class="font-label text-sm font-bold text-tertiary italic text-[10px]">1 200 Arbres Actifs</span>
        </div>
      ...
      <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
        <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm hover:scale-[1.02] transition-all">
          ...
          <p class="text-outline text-[10px] font-bold uppercase tracking-widest mb-1">Santé des arbres</p>
        ...
        <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm hover:scale-[1.02] transition-all">
          ...
          <p class="text-outline text-[10px] font-bold uppercase tracking-widest mb-1">Rendement estimé</p>
          <h3 class="text-3xl font-extrabold text-on-surface">14.2 <span class="text-sm font-medium text-outline">Tonnes</span></h3>
        </div>
        <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm hover:scale-[1.02] transition-all">
          <div class="p-3 bg-tertiary-container/20 rounded-xl text-tertiary w-fit mb-4">
            <span class="material-symbols-outlined">account_balance_wallet</span>
          </div>
          <p class="text-outline text-[10px] font-bold uppercase tracking-widest mb-1">Mes paiements</p>
        ...
        <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm hover:scale-[1.02] transition-all">
          ...
          <p class="text-outline text-[10px] font-bold uppercase tracking-widest mb-1">Humidité du sol</p>
      ...
      <section class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div class="bg-surface-container-lowest rounded-2xl p-8 shadow-sm border border-outline-variant/5 h-[320px] flex flex-col">
          <h4 class="text-xl font-bold font-headline mb-6">Croissance annuelle du rendement</h4>
        ...
        <div class="bg-surface-container-lowest rounded-2xl p-8 shadow-sm border border-outline-variant/5">
          <h4 class="text-xl font-bold font-headline mb-6">Aperçu du verger</h4>
          <div class="space-y-4">
            <div class="p-4 bg-tertiary-container/10 rounded-xl border border-tertiary/10">
              ...
              <p class="text-xs text-on-surface-variant leading-relaxed">
                Les secteurs Chemlali atteignent leur maturité optimale. Prévoyez leur récolte dans les prochaines 48h pour une meilleure qualité d'huile.
              </p>
            </div>
            <div class="p-4 bg-primary/5 rounded-xl border border-primary/10">
              ...
              <p class="text-xs text-on-surface-variant leading-relaxed">
                Vos parcelles ont passé avec succès le renouvellement de la certification bio 2024. Des bonus premium s'appliqueront à la récolte de cette année.
              </p>
            </div>
          </div>
        </div>
