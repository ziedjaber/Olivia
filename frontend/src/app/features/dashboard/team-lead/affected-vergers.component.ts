                  ...
                  <tr *ngFor="let v of pagedVergers" 
                    ...
                    <td class="px-6 py-5">
                       <div class="flex flex-col">
                          <span class="text-xs font-bold text-on-surface">{{ v.dateDerniereMaturite ? (parseDate(v.dateDerniereMaturite) | date:'MMM d, HH:mm') : 'En attente' }}</span>
...
export class AffectedVergersComponent implements OnInit {
  ...
  /** Safely converts any date string (including Java Date.toString() format) to a Date */
